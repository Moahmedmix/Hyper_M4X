...
function Aimbot:StartLoop()
    self.ConnManager:OnRenderStepped("aimbot_loop", function()
        self:Update()
    end)
end
...
function Aimbot:GetClosest(center)
    ...
    for _, player in ipairs(Players:GetPlayers()) do
        ...
        if Aimbot.Settings.TeamCheck and PlayerUtils.IsTeammate(player) then continue end
        ...
        if Aimbot.Settings.VisibleCheck and not PlayerUtils.IsVisible(player, Aimbot.Settings.AimPart) then continue end
        if Aimbot.Settings.WallCheck and not PlayerUtils.IsNotBehindWall(player, Aimbot.Settings.AimPart) then continue end
...
function Aimbot:Stop()
    self.ConnManager:DisconnectAll()
    if FOVCircle then
        FOVCircle.Visible = false
    end
end
