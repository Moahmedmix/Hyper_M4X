...
function Aimbot:GetBestTarget(center)
    ...
    for _, player in ipairs(Players:GetPlayers()) do
        ...
        table.insert(targets, { Player = player, Part = part, ScreenPos = screenPos, DistToCenter = distToCenter, Distance = (Camera.CFrame.Position - part.Position).Magnitude })
    end
    ...
    elseif Aimbot.Settings.Priority == "Health" then
        table.sort(targets, function(a, b)
            ...
            local hpA = ha and ha.Health or 100
            local hpB = hb and hb.Health or 100
            return hpA < hpB
        end)
